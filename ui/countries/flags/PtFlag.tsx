...
const PtFlag = (props: SvgIconProps) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g transform="translate(0 26.7) scale(1.06667)">
      ...
      />
      <g id="pt-e">
        <g id="pt-d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
          <path
            stroke="none"
          ...
          />
          <use xlinkHref="#pt-c" x={10.6} />
        </g>
        <use xlinkHref="#pt-d" y={46.3} />
        <use xlinkHref="#pt-d" transform="rotate(-45.2 312.8 180)" />
      </g>
      <use xlinkHref="#pt-d" x={45.7} />
      <use xlinkHref="#pt-e" transform="matrix(-1 0 0 1 479.8 0)" />
      <g id="pt-f" fill="#fff">
        <path
          fill="#039"
      ...
      <use xlinkHref="#pt-f" y={-26} />
      <use xlinkHref="#pt-f" x={-20.8} />
      <use xlinkHref="#pt-f" x={20.8} />
      <use xlinkHref="#pt-f" y={25.8} />
    </g>
  </svg>
)
