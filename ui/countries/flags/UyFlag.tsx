...
const UyFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    >
      <g id="uy-c">
        <g id="uy-b">
          ...
          <use xlinkHref="#uy-a" transform="rotate(45)" />
        </g>
        <use xlinkHref="#uy-b" transform="rotate(90)" />
      </g>
      <use xlinkHref="#uy-c" transform="scale(-1)" />
      <circle r={11} />
    </g>
    <g transform="translate(133.3 133.3) scale(.29333)">
      ...
      <use xlinkHref="#uy-d" transform="scale(-1 1)" />
