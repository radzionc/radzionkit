...
const ArFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g id="ar-c" transform="translate(-64) scale(.96)">
      ...
      />
      <use xlinkHref="#ar-a" transform="rotate(22.5 400 250)" />
      <use xlinkHref="#ar-a" transform="rotate(45 400 250)" />
      <use xlinkHref="#ar-a" transform="rotate(67.5 400 250)" />
      <path
        id="ar-b"
        fill="#85340a"
        d="M404.3 274.4c.5 9 5.6 13 4.6 21.3 2.2-6.5-3.1-11.6-2.8-21.2m-7.7-23.8 19.5 42.6-16.3-43.9"
      />
      <use xlinkHref="#ar-b" transform="rotate(22.5 400 250)" />
      <use xlinkHref="#ar-b" transform="rotate(45 400 250)" />
      <use xlinkHref="#ar-b" transform="rotate(67.5 400 250)" />
    </g>
    <use xlinkHref="#ar-c" transform="rotate(90 320 240)" />
    <use xlinkHref="#ar-c" transform="rotate(180 320 240)" />
    <use xlinkHref="#ar-c" transform="rotate(-90 320 240)" />
    <circle
      cx={320}
      cy={240}
    ...
    />
    <use xlinkHref="#ar-d" transform="matrix(-1 0 0 1 640.2 0)" />
    <use xlinkHref="#ar-e" transform="matrix(-1 0 0 1 640.2 0)" />
    <use xlinkHref="#ar-f" transform="translate(18.1)" />
    <use xlinkHref="#ar-g" transform="matrix(-1 0 0 1 640.2 0)" />
    <path
      fill="#85340a"
    ...
    />
    <use xlinkHref="#ar-h" transform="translate(-18.4)" />
    <circle
      id="ar-f"
      cx={310.9}
      cy={236.3}
