...
const CcFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g fill="#ffe000" transform="translate(0 80) scale(.0635)">
      <use xlinkHref="#cc-a" x={7560} y={4200} />
      <use xlinkHref="#cc-a" x={6300} y={2205} />
      <use xlinkHref="#cc-a" x={7560} y={840} />
      <use xlinkHref="#cc-a" x={8680} y={1869} />
      <use xlinkHref="#cc-b" x={8064} y={2730} />
    </g>
  </svg>
)

export default CcFlag
