...
const GiFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g stroke="#000" transform="translate(-160) scale(1.875)">
      <g id="gi-a" fill="#da000c" strokeLinecap="square">
        ...
        <path strokeLinecap="butt" d="M218.8 161.5H262" />
      </g>
      <use xlinkHref="#gi-a" transform="matrix(-1 0 0 1 512 0)" />
      <g fill="#f8d80e">
        <g strokeLinecap="round">
          ...
          <path
            strokeWidth={0.8}
            d="m238.9 150.2-1.2 3.3a86.6 86.6 0 0 1 15.8 8c1.7 1.2 3.5 2.3 4.8 3.9.3.8-.5 1.5-1.3 1.2-.7-.2-1.5-.5-2.2 0-1.1.5-2.1 2.2-.5 2.7 2.4 1.6 6.1.9 7.2-1.8.6-1.4.7-3.2-.5-4.4-2-2.3-4.8-4-7.4-5.7a89.2 89.2 0 0 0-14.7-7.2z"
          />
