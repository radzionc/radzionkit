...
const JeFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    <defs>
      <clipPath id="je-a">
        <path fillOpacity={0.7} d="M-5.3-6h40v30h-40z" />
      </clipPath>
    </defs>
    <g clipPath="url(#je-a)" transform="matrix(16 0 0 16 84.8 96)">
      ...
      <g stroke="#000">
        ...
        />
        <g fill="#f9dd16" stroke="none" strokeWidth={0.1}>
