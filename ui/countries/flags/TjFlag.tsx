...
const TjFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    />
    <use xlinkHref="#tj-a" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)" />
    <path
      id="tj-b"
      fill="#f8c300"
    ...
    />
    <use xlinkHref="#tj-b" fill="#f8c300" transform="rotate(9.4 320 551.3)" />
    <use xlinkHref="#tj-b" fill="#f8c300" transform="rotate(18.7 320 551.3)" />
    <path
      fill="none"
      stroke="#f8c300"
      strokeWidth={11}
    ...
    <g id="tj-d" fill="#f8c300" transform="translate(320 260.6) scale(.68571)">
      <use xlinkHref="#tj-c" transform="translate(-70 -121.2)" />
      <use xlinkHref="#tj-c" transform="translate(-121.2 -70)" />
      <use xlinkHref="#tj-c" transform="translate(-140)" />
    </g>
    <use xlinkHref="#tj-d" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)" />
  </svg>
)

export default TjFlag
