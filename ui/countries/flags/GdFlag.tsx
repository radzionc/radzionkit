...
const GdFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <use xlinkHref="#gd-c" transform="matrix(52.8 0 0 52.8 320 240)" />
    <use xlinkHref="#gd-d" x={-100} transform="translate(-30.3)" />
    <use
      xlinkHref="#gd-c"
      id="gd-d"
    ...
    />
    <use xlinkHref="#gd-d" x={-100} transform="translate(-30.3 414.6)" />
    <use xlinkHref="#gd-c" transform="matrix(31.2 0 0 31.2 320 448.2)" />
    <use xlinkHref="#gd-d" x={100} transform="translate(30.3 414.6)" />
  </svg>
)
