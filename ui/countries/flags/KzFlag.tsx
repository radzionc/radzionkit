...
const KzFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
      ...
      <g transform="matrix(.48 0 0 .48 345.8 201.6)">
        ...
        <g id="kz-c">
          <g id="kz-b">
            ...
            />
            <use xlinkHref="#kz-a" transform="rotate(90)" />
            <use xlinkHref="#kz-a" transform="scale(-1)" />
            <use xlinkHref="#kz-a" transform="rotate(-90)" />
          </g>
          <use xlinkHref="#kz-b" transform="rotate(22.5)" />
          <use xlinkHref="#kz-b" transform="rotate(45)" />
          <use xlinkHref="#kz-b" transform="rotate(67.5)" />
        </g>
        <use xlinkHref="#kz-c" transform="rotate(11.3)" />
      </g>
      ...
      <g transform="scale(.48)">
        <g id="kz-f">
          <g id="kz-e">
            ...
            />
            <use xlinkHref="#kz-d" transform="matrix(1 0 0 -1 0 645)" />
          </g>
          <use xlinkHref="#kz-e" transform="matrix(-1 0 0 1 240 0)" />
        </g>
        <use xlinkHref="#kz-f" transform="matrix(1 0 0 -1 0 1000)" />
      </g>
    </g>
  </svg>
)
