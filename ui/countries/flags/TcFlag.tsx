...
const TcFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
      ...
      <g strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2}>
        ...
        <g fill="#9e540a" transform="matrix(.125 0 0 .125 535 249.6)">
          <g id="tc-b">
            ...
            <g stroke="none">
              <use xlinkHref="#tc-a" stroke="#fcd116" strokeWidth={12} />
              <path
                id="tc-a"
          ...
          <use xlinkHref="#tc-b" transform="scale(-1 1)" />
          <g id="tc-c">
          ...
          <use xlinkHref="#tc-c" transform="scale(-1 1)" />
        </g>
        <g transform="matrix(.125 0 0 .125 485 299.6)">
          ...
          <use xlinkHref="#tc-d" transform="scale(-1 1)" />
