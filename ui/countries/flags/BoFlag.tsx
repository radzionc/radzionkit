...
const BoFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <circle cx={323.1} cy={237.4} r={0.6} />
    ...
    <circle cx={-316.9} cy={237.4} r={0.6} transform="scale(-1 1)" />
    ...
    />
    <path fill="#e7e7e7" fillRule="evenodd" d="M319.8 246h.4v.4h-.4v-.4z" />
    <path
      fill="none"
      stroke="#000"
      strokeWidth={0.1}
