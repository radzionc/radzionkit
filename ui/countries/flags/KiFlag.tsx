...
const KiFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    <defs>
      <clipPath id="ki-a">
        <path fillOpacity={0.7} d="M-86.3 0h682.6v512H-86.3z" />
      </clipPath>
    </defs>
    <g clipPath="url(#ki-a)" transform="translate(81) scale(.9375)">
      <path
        fill="#e73e2d"
        fillRule="evenodd"
