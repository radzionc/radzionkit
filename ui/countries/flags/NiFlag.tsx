...
const NiFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    />
    <g clipPath="url(#ni-c)" transform="matrix(.8 0 0 .8 -80 0)">
      <path
        fill="#fff"
      ...
      <g id="ni-e">
        ...
        <use xlinkHref="#ni-d" transform="rotate(72 500 285.5)" />
        <use xlinkHref="#ni-d" transform="rotate(144 500 285.5)" />
        <use xlinkHref="#ni-d" transform="rotate(-144 500 285.5)" />
        <use xlinkHref="#ni-d" transform="rotate(-72 500 285.5)" />
      </g>
      <use xlinkHref="#ni-e" transform="rotate(8 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(16 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(24 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(32 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(40 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(48 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(56 500 285.5)" />
      <use xlinkHref="#ni-e" transform="rotate(64 500 285.5)" />
      <path
        fill="red"
      ...
      <g fill="url(#ni-h)">
        ...
        <g id="ni-n" fill="url(#ni-i)">
          ...
          />
          <use xlinkHref="#ni-k" y={-1.1} fill="url(#ni-l)" />
          <use xlinkHref="#ni-k" y={-2.2} fill="url(#ni-m)" />
        </g>
        <use xlinkHref="#ni-n" y={-3.3} fill="url(#ni-o)" />
        <use xlinkHref="#ni-n" y={-6.7} fill="url(#ni-p)" />
        <path
          fill="url(#ni-q)"
      ...
      <g fill="#ccd11e">
        ...
        <use xlinkHref="#ni-w" x={-15.4} fill="#c6cb24" />
      </g>
      <path
        fill="#fff"
      ...
      <g id="ni-A">
        ...
        />
        <use xlinkHref="#ni-z" y={-1.3} />
        <use xlinkHref="#ni-z" y={-2.6} />
      </g>
      <use xlinkHref="#ni-A" y={-3.9} />
      <use xlinkHref="#ni-A" y={-7.7} />
      <path
        fill="#97c924"
