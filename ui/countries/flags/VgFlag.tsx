...
const VgFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g transform="translate(-217.5 -9.4) scale(.77497)">
      ...
      />
      <g id="vg-b" fill="#ffc72c" stroke="#000" strokeWidth={0.9}>
        <path
          fill="none"
          stroke="#ffc72c"
          strokeWidth={1.9}
      ...
      <use xlinkHref="#vg-b" x={-0.8} y={41.3} />
      <use xlinkHref="#vg-b" x={-1.1} y={82} />
      <use xlinkHref="#vg-b" x={25.6} y={126.1} />
      <use xlinkHref="#vg-b" x={-4.6} y={162.2} />
      <use xlinkHref="#vg-b" x={-3.8} y={204.8} />
      <use xlinkHref="#vg-b" x={146.3} y={0.7} />
      <use xlinkHref="#vg-b" x={144.9} y={41.2} />
      <use xlinkHref="#vg-b" x={143.1} y={82.7} />
      <use xlinkHref="#vg-b" x={145.2} y={123.4} />
      <use xlinkHref="#vg-b" x={144.7} y={164.2} />
      <use xlinkHref="#vg-b" x={144.9} y={205.2} />
