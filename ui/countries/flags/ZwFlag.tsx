...
const ZwFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g clipPath="url(#zw-a)" transform="matrix(1.1722 0 0 1.1426 -2.3 -.1)">
      ...
      <path
        id="zw-b"
        d="M124.8 217.8c-3 0-5.1 2.1-5.1 5.2 0 4.8 5.4 7.2 8.6 3.8s1-9-3.5-9zm0 1.2a4 4 0 0 1 4 4c0 3-3.3 5-6 3.7-2.7-1.5-2.5-6.1.4-7.3a4.3 4.3 0 0 1 1.5-.4z"
      />
      <use xlinkHref="#zw-b" x={-20.1} y={-0.6} />
