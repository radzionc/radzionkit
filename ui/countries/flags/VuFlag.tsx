...
const VuFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g clipPath="url(#vu-a)" transform="scale(.71111 1.01053)">
      <path
        stroke="#fdce12"
        strokeWidth={110}
    ...
    <g fill="#fdce12" transform="translate(-22) scale(1.01053)">
      ...
      <use xlinkHref="#vu-b" transform="matrix(-1 0 0 1 220 0)" />
    </g>
  </svg>
)

export default VuFlag
