...
const AdFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    width="1em"
    height="0.75em"
  ...
  >
    ...
    <g fill="none" stroke="#703d29">
      ...
      />
      <path strokeWidth={0.8} d="M319.7 329.1c-.3 1.7-1.9 3.6-5.3 4.2l-.6.2" />
      <path
        strokeWidth={0.9}
      ...
      <g strokeWidth={0.6}>
        ...
        <path strokeLinecap="round" d="M314.4 332.6a10 10 0 0 1-2.2 4.2" />
        ...
        <path
          strokeLinecap="round"
          d="m306.7 163.7 2.3-1.3c1-.6 2.3-.5 2.9.2.6.7.7 2-.2 2.8"
        />
        ...
        <path strokeLinecap="round" d="M244.7 259.4a16.5 16.5 0 0 1-6.3 6" />
        ...
        <path strokeLinecap="round" d="M253 189.8c-.3 1.3-1 2.9-3 2.7" />
      ...
      <g stroke="#c7b37f" strokeLinecap="round" strokeWidth={0.6}>
        ...
        <path strokeLinecap="butt" d="m254.2 225-1.2.5a5.1 5.1 0 0 1-1.5.3" />
    ...
    <g fill="#fedf00" transform="matrix(.64 0 0 .64 0 16)">
      ...
      />
      <use xlinkHref="#ad-a" transform="matrix(-1 0 0 1 907.5 0)" />
